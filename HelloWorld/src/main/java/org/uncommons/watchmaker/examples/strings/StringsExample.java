...
public final class StringsExample {
    ...
    public static String evolveString(String target)
    {
    	...
    	CandidateFactory<String> candidateFactory = new StringFactory(ALPHABET, 11);
        ...
        EvolutionaryOperator<String> evolutionOperatorsPipeline = new EvolutionPipeline<String>(operators);
        
        EvolutionEngine<String> engine = new GenerationalEvolutionEngine<String>(candidateFactory,
